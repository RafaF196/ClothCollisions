...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		ParticleSystem ps = new ParticleSystem(particle, new Vector3f(-1,9,-4.8f), 0.2f, 40);
		...
		RawModel mod2 = cm.addPlane(loader, new Vector3f(0, 1, 0), 10f);
		...
		while(!Display.isCloseRequested()) {
			...
			for (int i = 0; i < 10; i++) {
				if (delta < 1) ps.update(delta/10, cm, friction, bouncing);
			}
			TextMaster.render();
